        ...
        >
          ...
          <ul className="tList" onMouseOver={onHover} onMouseOut={offHover}  >
            ...
            <li value="2" className="row">
              <img  onClick={handleClickIMG} value="2" src={Translation} alt="2" className="col-md-auto" height="50px"  />
              <p value="2" className={list ? "col toolTitle" : "col toolTitleCollapsed"}>Translation</p>
            </li>
            <li value="3" className="row">
              <img  onClick={handleClickIMG} value="3" src={TexToSpeech} alt="3" className="col-md-auto" height="50px" />
              <p value="3" className={list ? "col toolTitle" : "col toolTitleCollapsed"}>Text To Speech</p>
            </li>
            <li value="4" className="row">
              <img  onClick={handleClickIMG} value="4" src={File} alt="4" className="col-md-auto" height="50px" />
              <p value="4" className={list ? "col toolTitle" : "col toolTitleCollapsed"}>Image Summary</p>
            </li>
          </ul>
        </div>
